...
c
c               solid-interface connections for nonlocal lstar
c               ----------------------------------------------
c
      type :: interface_solid_connections_lstar
        integer,  allocatable, dimension(:,:,:) :: list
      end type
      type(interface_solid_connections_lstar), save, allocatable,
     &           dimension(:) :: solid_interface_lists_lstar
c
